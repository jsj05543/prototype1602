...
<body>
	...
	<%-- お問い合わせ挿入 --%>
	<label>お問い合わせ情報の挿入</label>
	<s:form action ="MContactInsertAction">
		<s:textfield name="contact_id" placeholder="id"></s:textfield>
		<s:textfield name="contact_name" placeholder="件名"></s:textfield>
		<s:textarea size="400px" name="contact" placeholder="内容"></s:textarea>
		<s:submit label="お問い合わせ情報の追加" type="button"/>
	</s:form>
	<br>
	<br>
	<br>
